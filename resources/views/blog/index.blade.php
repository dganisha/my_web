				...
				@foreach($blogs as $blog)
 				<article class="post">
					<header class="entry-header">
 						...
 						<h1 class="entry-title"><a href="{{ route('blog.show', $blog->url_slug) }}" rel="bookmark">{{ $blog->title }}</a></h1>
					</header> 
					<div class="entry-content"> 
						<p><img alt="" src="{{ $blog->path_image }}"></p>
						<p><a href="{{ route('blog.show', $blog->url_slug) }}" class="more-link">Continue reading&#8230;</a></p>
					</div> 
				</article><!-- #post-## -->
				@endforeach
